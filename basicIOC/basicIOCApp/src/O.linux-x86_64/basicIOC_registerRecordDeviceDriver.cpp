...
/* Generated from ../O.Common/basicIOC.dbd */
...
int basicIOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/epics/repos/basicIOC";
...
/* basicIOC_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"basicIOC_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    basicIOC_registerRecordDeviceDriver(*iocshPpdbbase);
}
